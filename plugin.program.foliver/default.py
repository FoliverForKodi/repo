...
EXCLUDES     = ['plugin.program.foliver']
...
def wizard(name,url,description):
    ...
    time.sleep(2)
    dp.update(0,"", "Extracting foliver now, Please Wait")
    print '======================================='
    print addonfolder
    print '======================================='
    extract.all(lib,addonfolder,dp)
    dialog = xbmcgui.Dialog()
    dialog.ok("DOWNLOAD COMPLETE! ", 'To ensure all changes are saved you must now close Kodi', 'Unplug your device  or switch off from the power outlet NOW and leave for 30 seconds before switching back on.')
    killxbmc()
